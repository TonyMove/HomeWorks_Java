...
public class Main {
    ...
    public static void main(String[] args) {
        Box<Apple> appleBox1 = new Box<>(2, new Apple(), new Apple(), new Apple(), new Apple());
        Box<Apple> appleBox2 = new Box<>(1, new Apple(), new Apple());
        Box<Orange> orangeBox1 = new Box<>(1, new Orange(), new Orange(), new Orange());
